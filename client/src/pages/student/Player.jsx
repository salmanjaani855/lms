  ...
  return (
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
      ...
      <div className='md:mt-10'>
        {playerData ? (
          <div>
            <YouTube videoId={playerData.lectureUrl.split("/").pop()} iframeClassName='w-full aspec-video' />
            <div>
              <p className='flex justify-between items-center mt-1'>{playerData.chapter}.{playerData.lecture}{playerData.lectureTitle}</p>
              <button className='text-blue-600'>{false ? 'Completed' :'Mark Complete'}</button>
            </div>
          </div>
        )
        :
        <img className='' src={courseData ? courseData.courseThumbnail: ''} alt="" />
