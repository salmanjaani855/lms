  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-[36px] text-[28px] font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0,
          200
        )}}></p>
      ...
      <div className='flex'>
          ...
          (calculateRating(courseData)) ? assets.star : assets.star_blank} alt='' className='w-3.5 h-3.5' />
      ...
      <p className='text-blue-600'>{courseData.courseRatings.length} {courseData.
        ...
        <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Nancy</span></p>
      
      <div className='pt-8 text-gray-800'>
        <h2 className='text-xl font-semibold'>Course Structure</h2>
        <div className='pt-5'>
            {courseData.courseContent.map((chapter,index)=>(
              <div key={index} className='border border-r-gray-300 bg-white mb-2 rounded'>
      ...
      <div className='max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
          ...
          <div className='h-4 w-px bg-red-500/40'></div>
        ...
        <button className='md:mt-6 mt-4 w-full py-3 cursor-pointer rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' :'Enroll Now'}</button>
              ...
              <div className='pt-6'>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  ...
                  <li>Quizzes to test your knowldege</li>
